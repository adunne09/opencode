export const dict = {
  ...
  "prompt.action.attachAudio": "Attach audio",
  "prompt.action.recordAudio": "Record audio",
  "prompt.action.stopRecording": "Stop recording",
  "prompt.attachment.remove": "Supprimer la pièce jointe",
  "prompt.action.send": "Envoyer",
  "prompt.action.stop": "Arrêter",
  "prompt.audio.transcribing": "Transcribing...",
  "prompt.audio.transcribe": "Transcribe",
  "prompt.audio.retry": "Retry",
  "prompt.audio.cancel": "Cancel",
  "prompt.audio.ready": "Transcript ready",
  "prompt.audio.remove": "Remove audio",
  ...
  "prompt.toast.audioUnsupported.title": "Audio not supported",
  "prompt.toast.audioUnsupported.description": "This audio type isn't supported.",
  "prompt.toast.audioRecordingUnsupported.description": "Recording isn't available in this browser.",
  "prompt.toast.audioRecordingFailed.title": "Recording failed",
  "prompt.toast.audioRecordingFailed.description": "We couldn't access your microphone.",
  "prompt.toast.audioTooLarge.title": "Audio too large",
  "prompt.toast.audioTooLarge.description": "Audio must be under 25MB.",
  "prompt.toast.audioTranscribed.title": "Transcription ready",
  "prompt.toast.audioTranscribed.description": "Review the transcript, then send your message.",
